...
### auth0-github-deploy v3.5.4
### auth0-gitlab-deploy v3.5.4
### auth0-visualstudio-deploy v3.5.4
- #### Changed
  - Reverted: Bump source-control-extension-tools@4.1.9 to fix pagination in API calls
...
### auth0-github-deploy v3.5.0
### auth0-gitlab-deploy v3.5.0
### auth0-visualstudio-deploy v3.5.0
- #### Changed
